...
export default function CommunityPage({ url }: PageProps) {
  ...
  return (
    <>
      <Head>
        <title>`The ${domain} Community`</title>
        <meta
          name="description"
          content={`See all the members of the ${domain} community`}
        />
      </Head>
      ...
      <main className="container grid items-center gap-6 pb-8 pt-6 md:py-10">
        <div className="flex max-w-[980px] flex-col items-start gap-4">
          ...
          <p className="max-w-[500px] text-lg text-muted-foreground sm:text-xl">
            Want to join the {1} members of the {domain} community? Get your own
            {" "}
